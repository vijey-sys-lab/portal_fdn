...
import {
  MdDashboard, MdPeople, MdAssignment, MdBook,
  MdLogout, MdAdminPanelSettings, MdRateReview,
  MdPerson, MdBeachAccess
} from "react-icons/md";
...
export default function Sidebar() {
  ...
  const superAdminLinks = [
    ...
    { to: "/reviews", icon: <MdRateReview />, label: "Reviews" },
  ...
  const adminLinks = [
    ...
    { to: "/reviews", icon: <MdRateReview />, label: "Weekly Reviews" },
  ...
  const links =
    ...
    userRole === "admin" ? adminLinks : internLinks;
    ...
    <aside className="sidebar">
      ...
      <div style={{ padding: "12px 16px", borderTop: "1px solid var(--border)", background: "var(--bg-secondary)" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
          <div style={{ width: 36, height: 36, borderRadius: "50%", background: "var(--accent-glow)", border: "2px solid var(--accent)", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 700, color: "var(--accent)", fontSize: 14, flexShrink: 0 }}>
            {initials}
          </div>
